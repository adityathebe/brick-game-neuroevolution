...
class NeuralNetwork {
    constructor(input_nodes, hidden_nodes, output_nodes) {
        if (input_nodes instanceof NeuralNetwork) {
            let parent = input_nodes;
            this.input_nodes = parent.input_nodes;
            this.hidden_nodes =parent.hidden_nodes;
            this.output_nodes = parent.output_nodes;

            // Initialize random weights
            this.input_weights = parent.input_weights;
            this.output_weights = parent.output_weights;
    ...
    clone() {
        let cloned = new NeuralNetwork(this)
        return cloned;
    }
